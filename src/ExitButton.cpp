...
ExitButton::ExitButton(std::string t, sf::Vector2f size, sf::Color bgcolor)
    : text(font)  // Initialize text with font
{
...
void ExitButton::Start(sf::RenderWindow& window, sf::Vector2f pos)
{
...
void ExitButton::ChangeColor(sf::RenderWindow& window) {
